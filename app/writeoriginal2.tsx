...
//           <div  >
//             <div className=" md:mr-2 mr-0 mt-2 flex  justify-center rounded-3xl ">
//               <div className="flex items-center border-[#e1e0de]  border-2 px-1 md:px-4 py-1 rounded-3xl">
//                 <div>
//                   <span className="text-[10px] hidden md:block md:ml-0 md:text-[20px] font-medium rounded-3xl py-1 cursor-pointer">
...
//             <p className="font-relative   text-3xl text-center md:hidden block tracking-tight mt-3">Website</p>
//             <p className="font-relative   text-3xl md:hidden text-center block tracking-tight">designed & built </p>
//             <p className="font-relative  text-3xl text-center   md:hidden block tracking-tighter">faster with AI</p>
...
//           <button className="border-2  border-[#d0d0ce] text-[#686868] bg-[rgba(241,240,238,255)] flex text-[12px] justify-center  items-center  rounded-3xl font-relative px-2 py-2 ml-4 ">
//             <FaFigma
//               className="mr-2
// "
//             />{" "}
...
//               className=" mb-14 rounded-xl block md:hidden" 
//             />
//             {/* <Image src={jessica} alt="jessica" width={100} className="mb-5 ml-200 rounded-xl "/> */}
...
//               alt="untillknows"
//               width={50}
//               className="mb-14   block md:hidden   rounded-xl"
//             />
...
//         {/* this is related the laptop version */}
