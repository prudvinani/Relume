  ...
  return (
    <div>
      <div className="font-relative bg-[rgba(241,240,238,255)] h-[650px] hover:bg-[rgba(242,239,255,255)]  ">
        <p className="text-white bg-black text-center p-2 text-[18px] flex justify-center items-center w-full z-20">
          <Image
            src={reactlogo1}
            alt="reactlogo"
            width={20}
        ...
        <div className="flex justify-between items-center text-xl pt-8 mx-[50px]">
          <div className="flex items-center justify-center">
            <Image
              ...
              className="mr-2"
            />
            {/* <p className="font-relative font-extrabold text-[30px] leading-6 text-[rgb(51,51,51)]">Relume</p> */}
            <Image
              src={relumefonts}
              alt="relumefont"
              width={90}
        ...
        >
          ...
          >
            <Image
              ...
              alt="allzakelly"
              width={250}
              className="ml-3 mb-4 rounded-xl"
            />
            ...
            <Image
              ...
              alt="untillknows"
              width={250}
              className="mb-5 mr-14   rounded-xl"
            />
          ...
          <div >
            <div className="mr-2 mt-2 flex  justify-center rounded-3xl ">
              <div className="flex items-center border-[#e1e0de]  border-2 px-4 py-1 rounded-3xl">
                <div>
                  <span className="text-[20px] font-medium rounded-3xl py-1 cursor-pointer">
            ...
            <p className="text-9xl tracking-tight font-relative mt-10">
              Website designed &
            </p>
            <p className="text-9xl font-relative">built faster with AI</p>
...
"
      ...
      <div className="flex items-center justify-center pt-8 hover:s bg-[rgba(241,240,238,255)] ">
        <div
          style={{
            background: `
        ...
        relative p-4 w-[950px] 
      "
        >
          <input
            type="text"
            placeholder="Describe a company in a sentence or two..."
            className="w-full p-3 text-gray-600 text-2xl placeholder-gray-500 outline-none rounded-3xl cursor-pointer"
          />
