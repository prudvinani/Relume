...
export default function Home() {
  ...
  return (
    <div>
      <div
        className="font-relative  bg-[rgba(241,240,238,255)] h-[1200px] md:h-[550px] hover:bg-[rgba(242,239,255,255)]  "
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <p className="text-[102px] font-relative md:block hidden">
              ...
              <p className="font-relative   text-5xl text-center md:hidden block tracking-tight mt-3">
                Website
              </p>
              <p className="font-relative   text-5xl md:hidden text-center block tracking-tight">
                designed & built{" "}
              </p>
              <p className="font-relative  text-5xl text-center   md:hidden block tracking-tighter">
                faster with AI
              </p>
              <p className="block md:hidden text-center mx-5  pt-4">
                Use AI as your design ally, not as a replacement . Effortlessly
                generate sitemaps abd wireframers for marketing websites in
                minute
              </p>
